...
class FriendshipAcceptanceNotification extends Notification implements ShouldBroadcast
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'message' => "{$this->event->receiver->name} has accepted your friendship request.",
